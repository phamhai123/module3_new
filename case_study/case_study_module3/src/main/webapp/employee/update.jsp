...
<div class="container">
    <form action="/Employees" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" aria-describedby="helpId" value="${employee.name}">
        ...
        <div class="row">
            <div class="mb-3 col-sm-6">
                ...
                <input type="date" class="form-control" name="birthday" id="birthday" aria-describedby="helpId" value="${employee.birthday}">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <input type="text" class="form-control" name="idcard" id="idcard" aria-describedby="helpId" value="${employee.idCard}">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <input type="text" class="form-control" name="salary" id="salary" aria-describedby="helpId" value="${employee.salary}">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <input type="text" class="form-control" name="phone" id="phone" aria-describedby="helpId" value="${employee.phone}">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <input type="text" class="form-control" name="email" id="email" aria-describedby="helpId" value="${employee.email}">
            ...
            <div class="mb-3 col-sm-6">
                ...
                <input type="text" class="form-control" name="address" id="address" aria-describedby="helpId" value="${employee.address}">
